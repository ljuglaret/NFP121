...
public class TestsTransaction extends junit.framework.TestCase{
    ...
    public void testDebitEnErreur(){
        ...
        try{
            g.debit(120);//erreur car contributeur gc a un solde égal à 100. et 100<120
            //or le solde après un débit ne peut être négatif.
    ...
    public void testDebitAvecTransaction(){
        ...
        try{
            transaction.debit(120);//erreur car contributeur gc a un solde égal à 100. et 100<120
            //or le solde après un débit ne peut être négatif.
        }catch(Exception e){}
