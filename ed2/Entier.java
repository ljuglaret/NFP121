/**
* classe Entier 
* redefinition des méthodes de la classe Integer
* @Laure Juglaret
* @v1.0.0
*/
...
public class Entier
{
    ...
    public Integer af(){return new Integer(getEntier());}
    ...
    public boolean equals (Object o2){
        if (o2 instanceof Entier){
            return  entier ==  ((Entier)o2).entier ;
        }
        else{
            return false;
        }
    ...
    public static Entier parseEntier(String str) throws NumberFormatException{
        ...
        if(! ( (taille == 1 && Character.isDigit(premierChar)) || (premierChar == '-'  && taille > 1) || (Character.isDigit(premierChar)&& taille > 1)))   {
    ...
    /*
    toute base b contient b - 1 éléments
    la base 16 est représentée par : 
    0 - 1 - 2 ... - 10 - 11 - 12 - 13 - 14 - 15
    Pour éviter toute confusion         10 - 11 - 12 - 13 - 14 - 15
    sont respectivement remplacés par :  A - B  -  C -  D  - E - F
    */
    ...
    /*lors d'une conversion d'un entier x exprimé en base 10 vers sa représentation en base 16
        * on divise successivement x par 16 et on enregistre les restes : r0, r1, r2,...,rp. 
        * la condition de fin est : x/16 = 0
        * x en base 16 se lit : rp,...,r2,r1,r0
       */
